...
\name{Annika Hannemann} % Your name
...
\aboutdesc{Wagnerstr. 7\\94469 Deggendorf\\annika.hannemann@stud.th-deg.de}
\location{} % Address/location
\phone{} % Phone number
\mail{} % Mail
\dateofbirth{14.01.1998} % Date of birth
...
\makecontact{PERSÖNLICHES}

% \makedob{NAME FOR DATE OF BIRTH SECTION}
\makedob{GEBURTSDATUM}
