...
\definecolor{sidebarbackground}{HTML}{EEEEE0}
...
\definecolor{bulletcolor}{HTML}{EEEEE0}
\definecolor{linkcolor}{HTML}{3E78B2}
\definecolor{linecolor}{HTML}{EEEEE0}
\definecolor{name}{HTML}{000000}
\definecolor{jobtitle}{HTML}{000000}
    ...
    \ifthenelse{\equal{#1}{}}{\booltrue{langempty}}{\renewcommand{\langskills}{%
        ...
        \foreach [count=\i] \x/\y in {#1}{%
            \begin{tabular*}{\columnwidth}{@{}L{.4\columnwidth}L{.6\columnwidth}}
                {\x} &
                \foreach \z in {1,...,5}{%
                    {\ifnumgreater{\z}{\y}{\color{bodytext}}{\color{bodytext!30}}\small{\faCircle}}}\\
            \end{tabular*}
        }
    }}
}
